...
public class HelloJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		float jobFloatJobValue = dataMap.getFloat("floatJobValue");
		String trMessage = tDataMap.getString("message");
		Double trDouble = tDataMap.getDouble("DoubleTriggerValue");
		...
		*/
		...
		float jobFloatJobValue = dataMap.getFloat("floatJobValue");
		Double trDouble = dataMap.getDouble("DoubleTriggerValue");
